...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white shadow-sm border-b border-gray-100 px-4 md:px-8 py-2 md:py-3 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-4 md:gap-8">
          ...
          <img
            src={GreenhillsLogo}
            alt="Greenhills Logo"
            /* Increased height: h-14 for mobile, h-20 for desktop */
            className="h-14 md:h-20 w-auto object-contain cursor-pointer hover:opacity-80 transition py-1"
            onClick={() => navigate("/")}
          />
